...
// Valid RB3 commands that Overdrive does not yet expose as editable venue or
// section controls. Retain them so import -> edit -> export preserves behavior.
export interface PreservedMidiTextEvent {
  id: string
  tick: number
  track: 'EVENTS' | 'VENUE'
  text: string
...
export interface VenueTrackData {
  ...
  preservedTextEvents?: PreservedMidiTextEvent[]
}
